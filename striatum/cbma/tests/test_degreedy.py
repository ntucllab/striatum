...
from striatum.cbma import degreedy
...
class TestEpsilonGreedy(unittest.TestCase):
    ...
    def test_initialization(self):
        policy = degreedy.DecreasingEpsilonGreedy(self.actions, self.historystorage, self.modelstorage, 0.1, 0.001, 2)
        self.assertEqual(self.actions, policy._actions)
        self.assertEqual(0.001, policy.rho)
        self.assertEqual(0.1 * (1 + 0.001), policy.explr_prob)
